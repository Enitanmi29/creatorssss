...
{/* CONTACT SECTION */}
 ...
 {/* NEWS LETTER SECTION */}
              <div className='bg-[#009499] rounded-lg mx-6 md:mx-20 my-20'>
                <h1 className='text-white text-xl md:text-2xl font-bold pl-8 md:pl-20 pt-10 pb-4'>
                  Newsletter Subscription
                </h1>
                <div className='flex flex-col md:flex-row items-center py-4 md:py-8 md:pl-20'> 
                  <input 
                  className='pl-4 w-[280px] md:w-[553px] border-2 border-[#4d7475] rounded-xl bg-[#009499] 
                  font-sans font-normal text-[14px] py-4 mb-10 text-[#FFFFFF]'
                  type='email'
                  id=''
                  placeholder='Enter email address'
                  />
                  <button className='bg-white flex justify-center font-bold border border-blue-200 rounded-xl ml-0 md:ml-8 px-6 md:px-4 py-4 mb-10'>
                      Subscribe           
                  </button>
                </div>    
              </div>
