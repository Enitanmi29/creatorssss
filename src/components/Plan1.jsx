    ...
    {/* PACKAGES SECTION */}
        ...
        <div className='bg-[#e4e3e3] mt-20 mx-10'>
            ...
            <div className='flex justify-center'> 
               <ul className=' rounded-lg px-4 grid grid-cols-2 md:grid-cols-2'>
                {packages.map ((packages, index) =>(
                    <div key={index} className='bg-white rounded-2xl border-4 ml-0 md:ml-10 pl-4 md:pl-8 pr-20 py-4 mb-8'>
                        ...
                        <h2 className='font-bold text-black text-3xl mb-2'>
                         ...
                         <div className='rounded-xl border border-green-800 text-green-500 mb-2 px-10 py-4 mr-40'>
                            {packages.link}
                         </div>                   
                    </div>
                ))}
